...
var $author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$author$project$Main$viewInput(model.field),
				A2($author$project$Main$viewEntries, model.visibility, model.entries),
				A2($author$project$Main$viewControls, model.visibility, model.entries)
			]));
};
