...
var $author$project$Todo$viewKeyedEntry = function(todo) {
	return { a3: $gren_lang$core$String$fromInt(todo.c), ba: A2($gren_lang$browser$Html$Lazy$lazy, $author$project$Todo$viewEntry, todo) };
};
